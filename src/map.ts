...
export default class Map {
    ...
    constructor() {
        this.nodes = [
            new GraphNode(1, new Position(-6.5, -7)),
            new GraphNode(2, new Position(-6.5, -4.7)),
            new GraphNode(3, new Position(-6.5, -1.3)),
            new GraphNode(4, new Position(-6.5, 1.3)),
            new GraphNode(5, new Position(-6.5, 4.7)),
            new GraphNode(6, new Position(-6.5, 7)),

            new GraphNode(7, new Position(-5.5, -7)),
            new GraphNode(8, new Position(-5.5, -4.7)),
            new GraphNode(9, new Position(-5.5, -1.3)),
            new GraphNode(10, new Position(-5.5, 1.3)),
            new GraphNode(11, new Position(-5.5, 4.7)),
            new GraphNode(12, new Position(-5.5, 7)),

            new GraphNode(13, new Position(-0.5, -7)),
            new GraphNode(14, new Position(-0.5, -4.7)),
            new GraphNode(15, new Position(-0.5, -1.3)),
            new GraphNode(16, new Position(-0.5, 1.3)),
            new GraphNode(17, new Position(-0.5, 4.7)),
            new GraphNode(18, new Position(-0.5, 7)),

            new GraphNode(19, new Position(0.5, -7)),
            new GraphNode(20, new Position(0.5, -4.7)),
            new GraphNode(21, new Position(0.5, -1.3)),
            new GraphNode(22, new Position(0.5, 1.3)),
            new GraphNode(23, new Position(0.5, 4.7)),
            new GraphNode(24, new Position(0.5, 7)),

            new GraphNode(25, new Position(5.5, -7)),
            new GraphNode(26, new Position(5.5, -4.7)),
            new GraphNode(27, new Position(5.5, -1.3)),
            new GraphNode(28, new Position(5.5, 1.3)),
            new GraphNode(29, new Position(5.5, 4.7)),
            new GraphNode(30, new Position(5.5, 7)),

            new GraphNode(31, new Position(6.5, -7)),
            new GraphNode(32, new Position(6.5, -4.7)),
            new GraphNode(33, new Position(6.5, -1.3)),
            new GraphNode(34, new Position(6.5, 1.3)),
            new GraphNode(35, new Position(6.5, 4.7)),
            new GraphNode(36, new Position(6.5, 7)),

            new GraphNode(37, new Position(-10.5, -3.5)),
            new GraphNode(38, new Position(-7.7, -3.5)),
            new GraphNode(39, new Position(-4.3, -3.5)),
            new GraphNode(40, new Position(-1.7, -3.5)),
            new GraphNode(41, new Position(1.7, -3.5)),
            new GraphNode(42, new Position(4.3, -3.5)),
            new GraphNode(43, new Position(7.7, -3.5)),
            new GraphNode(44, new Position(10.5, -3.5)),

            new GraphNode(45, new Position(-10.5, -2.5)),
            new GraphNode(46, new Position(-7.7, -2.5)),
            new GraphNode(47, new Position(-4.3, -2.5)),
            new GraphNode(48, new Position(-1.7, -2.5)),
            new GraphNode(49, new Position(1.7, -2.5)),
            new GraphNode(50, new Position(4.3, -2.5)),
            new GraphNode(51, new Position(7.7, -2.5)),
            new GraphNode(52, new Position(10.5, -2.5)),

            new GraphNode(53, new Position(-10.5, 2.5)),
            new GraphNode(54, new Position(-7.7, 2.5)),
            new GraphNode(55, new Position(-4.3, 2.5)),
            new GraphNode(56, new Position(-1.7, 2.5)),
            new GraphNode(57, new Position(1.7, 2.5)),
            new GraphNode(58, new Position(4.3, 2.5)),
            new GraphNode(59, new Position(7.7, 2.5)),
            new GraphNode(60, new Position(10.5, 2.5)),

            new GraphNode(61, new Position(-10.5, 3.5)),
            new GraphNode(62, new Position(-7.7, 3.5)),
            new GraphNode(63, new Position(-4.3, 3.5)),
            new GraphNode(64, new Position(-1.7, 3.5)),
            new GraphNode(65, new Position(1.7, 3.5)),
            new GraphNode(66, new Position(4.3, 3.5)),
            new GraphNode(67, new Position(7.7, 3.5)),
            new GraphNode(68, new Position(10.5, 3.5)),
        ]
