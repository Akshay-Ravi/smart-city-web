...
export const FRAMES_PER_MOVEMENT = 3; // Higher value reduces car speed
export const CAR_SPEED = 0.1; // Higher value increases car speed (MUST BE A FACTOR OF 0.1)
export const TURN_FRAMES_PER_MOVEMENT_STRAIGHT = 1.5; // Higher value reduces the turn speed for straight turns
